...
class Job(models.Model):
    ...
    region = models.ForeignKey(Region, related_name='jobs', on_delete=models.CASCADE, blank=True, null=True)
    state = models.ForeignKey(State, related_name='jobs', on_delete=models.CASCADE, blank=True, null=True)
